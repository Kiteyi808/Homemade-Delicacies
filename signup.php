						...
						<h4 class=" font">Signup</h4>
                         ...
                         if(isset($_GET['error'])){
                         	...
                         	elseif($_GET['error']=="invaliduidemail"){
                               ...
                               echo '<p class="colorbb">*Invalid email and username</p>';
                         	...
                         	elseif($_GET['error']=="invalidemail"){
                               ...
                               echo '<p class="colorbb">*Invalid email</p>';
                              ...
                              elseif($_GET['error']=="invaliduid"){
                               ...
                               echo '<p class="colorbb">*Invalid username</p>';

                         	}
                         	elseif($_GET['error']=="passwordcheck"){

                               echo '<p class="colorbb">*The passwords do not match</p>';
                         	...
                         	elseif($_GET['error']=="usertaken"){
                               ...
                               echo '<p class="colorbb">*This username is already taken</p>';
